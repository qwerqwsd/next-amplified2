...
// import { Appointment } from '../pages/appexample'  // Import the Appointment interface

// interface AddAppointmentProps {
//   onSendAppointment: (appointment: Appointment) => void;
//   lastId: number;
// }

// const AddAppointment: React.FC<AddAppointmentProps> = ({ onSendAppointment, lastId }) => {
//   const clearData = {
//     ownerName: '',
//     petName: '',
//     aptDate: '',
